...
if(preklapanje == 0){
    console.log(`Doktor 1 i Doktor 2 nisu u istoj smeni. Nema preklapanja u smeni.`);
    para1.innerHTML = `Doktor 1 i Doktor 2 nisu u istoj smeni. Nema preklapanja u smeni.`;
